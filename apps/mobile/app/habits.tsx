...
import { DailyLungState, useTodayLungState } from '@/components/LungProgress';
...
export default function HabitsScreen() {
  ...
  const { data: todayState, reload: reloadTodayState } = useTodayLungState();
  ...
  async function logAvoided() {
    await api.post('/events/cravings/avoided', {});
    reloadTodayState();
  }
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <DailyLungState state={todayState} />
      ...
      <Pressable style={styles.avoidedButton} onPress={logAvoided}>
        <Text style={styles.avoidedButtonText}>✅ Evité un cigarrillo</Text>
      </Pressable>
...
const styles = StyleSheet.create({
  ...
  avoidedButtonText: { color: '#4C9A6A', fontSize: 15, fontWeight: '700' },
